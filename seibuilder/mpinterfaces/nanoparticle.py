...
from . import get_struct_from_mp
...
class Nanoparticle(Molecule):
    ...
    def __init__(self, structure, rmax=15, hkl_family=((1, 0, 0), (1, 1, 1)), surface_energies=(28, 25)):
    ...
    def get_normals(self):
        ...
        for hkl in self.all_equiv_millers:
            normal = (
                self.recp_lattice.matrix[0, :] * hkl[0]
    ...
    def create(self):
        ...
        normalized_surface_energies = np.array(self.all_surface_energies) / float(max(self.all_surface_energies))
...
if __name__ == "__main__":
    ...
    nanoparticle = Nanoparticle(
        structure_conventional, rmax=rmax, hkl_family=surface_families, surface_energies=surface_energies
    )
    nanoparticle.create()
