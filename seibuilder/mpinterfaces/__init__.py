"""
A portion of MPInterfaces packages by Richard G. Hennig et al. (Henniggroup Cornell/University).

We took only part of the code due to conflicts raised from installing all the packages.
check https://github.com/henniggroup/MPInterfaces
"""
...
__author__ = (
    "Kiran Mathew, Joshua J. Gabriel, Michael Ashton, "
...
def get_struct_from_mp(formula, MAPI_KEY="", all_structs=False):
    ...
    with MPR as m:
        ...
        if all_structs:
            ...
            print(f"The id of the material corresponding to the lowest energy above the hull = {mineah_key}")
            if mineah_key:
